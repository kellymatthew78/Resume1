...
//bolierplate
Library.prototype.xtry = function () {
    try {
...
Library.prototype.addBookArray = function (BookArray, msg = true) {
    try {
        ...
        console.log("addBookArray triggered: " + e);
    }
};
...
//popup click event that will add a book to library
...
//controls the removes authos popup ans then calls the function to remove chasedn authos from library.
